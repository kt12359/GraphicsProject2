...
void Stand::Initialize(){
	...
	gluCylinder(quad, base, top, height+2, slices, stacks);
...
void Seat::Initialize(){
	...
	//for(int i = 0; i < 13; ++i)
		makeRectPrism(4,3);
	    glTranslatef(0.0,yPos*0.0,zPos+zPos*(1.0/6.0));
		makeRectPrism(4,3);
    glTranslatef(0.0,yPos*(2.0/3.0),zPos);
	makeRectPrism(4,3);
	glTranslatef(0.0,yPos,zPos*(2.0/3.0));
	makeRectPrism(4,3);
    glTranslatef(0.0,yPos+yPos*(1.0/6.0),zPos*(1.0/6.0));
	makeRectPrism(4,3);
    glTranslatef(0.0,yPos,-zPos*(1.0/3.0));
	makeRectPrism(4,3);
    glTranslatef(0.0,yPos*(2.0/3.0),-zPos*(2.0/3.0));
	makeRectPrism(4,3);
